...
credentials out of Git. For a new user, open
`https://mercury-tools-mcp.onrender.com/connect`, enter the invite code, and
copy the single Codex setup command generated by Mercury Connect.
