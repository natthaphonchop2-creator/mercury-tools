...
`list_workspace_flows` and `run_workspace_flow` use the Mercury client token
generated by the Connect page to resolve the correct workspace. They do not
require or expose the Supabase service role key to the MCP host.
