...
```bash
git add supabase/migrations/20260719120000_connector_neutral_profiles.sql tests/test_connector_neutral_profile_migration.py src/mercury_tools/db/product.py src/mercury_tools/cloud/models.py src/mercury_tools/cloud/api.py tests/test_product_fallback.py tests/test_connector_setup.py tests/test_cloud_secret_removal.py
